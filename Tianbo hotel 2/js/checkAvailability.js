...
const ROOMS = ROOM_RESERVATIONS.map(v => v.room);
processDates(ROOM_RESERVATIONS);
 ...
 */
function processDates(ROOM_RESERVATIONS) {
    let bookedDates = findBookedDates(ROOM_RESERVATIONS);
    ...
    let specificRoom = document.getElementById("roomType").value;
